...
public class DiseaseControlUnit extends MedicalUnit {
	...
	public void respond(Rescuable r) throws IncompatibleTargetException, CannotTreatException {
		if(r instanceof ResidentialBuilding)
			throw new IncompatibleTargetException(this, r, "Cannot handle a building's disaster using a Disease Control Unit");

		if(!canTreat(r))
			throw new CannotTreatException( this , r , "This citizen cannot be treated as it doesnt suffer from this type of disaster!");
